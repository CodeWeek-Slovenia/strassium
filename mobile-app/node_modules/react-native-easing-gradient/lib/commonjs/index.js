...
exports.easeGradient = easeGradient;

var _reactNative = require("react-native");

var _createInterpolation = require("./create-interpolation");

const easeInOut = _reactNative.Easing.bezier(0.42, 0, 0.58, 1);
...
function easeGradient({
  ...
  for (let currentStopIndex = 0; currentStopIndex < totalColorStops - 1; currentStopIndex++) {
    ...
    const colorScale = (0, _createInterpolation.createInterpolation)({
      inputRange: [0, 1],
    ...
    for (let stepIndex = 0; stepIndex <= TOTAL_STOPS_PER_TRANSITION - 1; stepIndex++) {
